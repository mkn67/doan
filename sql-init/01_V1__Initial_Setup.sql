...
-- ── I.1 RBAC & NHÂN SỰ ──────────────────────────────────────
-- ============================================================
-- PHẦN I: TẠO BẢNG & RÀNG BUỘC (ĐÃ TỐI ƯU HÓA)
-- ============================================================
...
CREATE TABLE TAI_KHOAN (
    ...
    LOAI_TK   NVARCHAR2(20) DEFAULT 'INTERNAL',  -- INTERNAL: Nhân sự | EXTERNAL: Khách hàng
    TRANGTHAI NUMBER(1)     DEFAULT 1            -- 1: Hoạt động | 0: Bị khóa
);

-- Bảng trung gian giải quyết bài toán 1 tài khoản nhiều nhóm quyền
CREATE TABLE TAIKHOAN_NHOM (
    ...
    CONSTRAINT FK_TKN_NHOM FOREIGN KEY (MANHOM) REFERENCES NHOM(MANHOM)
);
...
CREATE TABLE XU_LY_KINH (
    ...
    MANS_KY_THUAT   VARCHAR2(10)  NULL,
    GHI_CHU         NVARCHAR2(255),
...
-- 14. Tạo Mã và STT Hàng Chờ (Bản Compound xịn)
...
-- SP 2: Chốt thanh toán (ĐÃ XÓA PHẦN PHIẾU XUẤT DO ĐÃ BỎ BẢNG)
CREATE OR REPLACE PROCEDURE SP_CHOT_THANH_TOAN_HOA_DON (
    ...
    v_tongtien NUMBER; v_mans VARCHAR2(10); v_matt VARCHAR2(10);
BEGIN
...
-- SP 10: Tạo hóa đơn (FIX DONGIA CHO CT_HOA_DON)
...
BEGIN
    ...
    -- Tồn kho tự hoàn về qua TRG_HOA_DON_HUY
