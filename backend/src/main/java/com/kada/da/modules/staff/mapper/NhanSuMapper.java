...
public class NhanSuMapper {
    ...
    public static TopBacSiDTO toTopBacSiDTO(VRatingBacSi entity) {
        return TopBacSiDTO.builder()
                .maNs(entity.getMaNs())
                .tenBacSi(entity.getHoTen())
                // Đã xóa cái dòng lỗi củ chuối ở đây
                .tongSoCaKham(entity.getTongLuotDanhGia())
                .diemDanhGiaTrungBinh(entity.getRatingTrungBinh())
                .build();
    }
